@extends('layouts.app')
@section('title','Register Senior Citizen')
@section('content')<h2 class="mb-3">Register Senior Citizen</h2><div class="card"><div class="card-body"><form method="POST" action="{{ route('senior-citizens.store') }}">@csrf
<div class="row g-3">
